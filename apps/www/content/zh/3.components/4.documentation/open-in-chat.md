...
`OpenIN` 组件提供了一个下拉菜单，允许用户一键在不同的 AI 聊天平台中打开查询。

:::ComponentLoader{label="Preview" componentName="OpenInChat"}
:::
...
```vue [providers/items/OpenInChatGPT.vue]
<script setup lang="ts">
...
```vue [providers/items/OpenInClaude.vue]
<script setup lang="ts">
import { computed } from 'vue'
import { providers } from '..'
import { useOpenInContext } from '../../context'
...
```vue [providers/items/OpenInCursor.vue]
<script setup lang="ts">
import { computed } from 'vue'
import { providers } from '..'
import { useOpenInContext } from '../../context'
...
```vue [providers/items/OpenInScira.vue]
<script setup lang="ts">
import { computed } from 'vue'
import { providers } from '..'
import { useOpenInContext } from '../../context'
...
```vue [providers/items/OpenInT3.vue]
<script setup lang="ts">
import { computed } from 'vue'
import { providers } from '..'
import { useOpenInContext } from '../../context'
...
```vue [providers/items/OpenInv0.vue]
<script setup lang="ts">
import { computed } from 'vue'
import { providers } from '..'
import { useOpenInContext } from '../../context'
...
```vue [providers/icons/ChatGPT.vue]
<template>
  <svg
    fill="currentColor"
    role="img"
...
```vue [providers/icons/Claude.vue]
<template>
  <svg
    fill="currentColor"
    role="img"
...
```vue [providers/icons/Cursor.vue]
<template>
  <svg
    version="1.1"
...
```vue [providers/icons/Github.vue]
<template>
...
:::field-group
  ::field{name="query" type="string" defaultValue="''"}
